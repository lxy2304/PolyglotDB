...
from ..io.importer import (subannotations_data_to_csv, import_subannotation_csv, import_token_csv, import_csv_with_timestamp)
...
class AnnotatedContext(SummarizedContext):
    ...
    def enrich_tokens_with_csv(self, path, annotated_type, id_column=None, discourse_id_column=None, timestamp_column=None, properties=None):
        ...
        if id_column:
            ...
            import_csv_with_timestamp(self, path, annotated_type, timestamp_column=timestamp_column, discourse_column=discourse_id_column, properties=properties)